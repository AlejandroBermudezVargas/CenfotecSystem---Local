...
Namespace My.Resources
    ...
    Friend Class respuestasDelSistema
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a ocurrio un error al insertar el usuario!.
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a Tu rol se encuentra desactivado..
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a El usuario se encuentra inactivo en el sistema.
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a El usuario no ha podido ser modificado.
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a El rol no ha podido se modificado.
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a El rol ha sido modificado correctamente!.
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a El usuario ha sido modificado con exito!.
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a La combinacion de correo y contraseña es incorrecta.
        '''</summary>
